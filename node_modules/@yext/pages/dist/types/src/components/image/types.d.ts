 ...
 * @public
 */
export declare const ImageLayoutOption: {
    /**
 ...
 * @public
 */
export declare type ImageLayout = typeof ImageLayoutOption[keyof typeof ImageLayoutOption];
/**
 ...
 * @public
 */
export declare type ImageProps = OtherImageProps | FixedImageProps | AspectImageProps;
export {};
