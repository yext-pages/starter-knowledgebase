...
exports.defaultEndpoints = exports.defaultApiVersion = exports.SandboxEndpoints = void 0;
...
_Object$defineProperty(exports, "SandboxEndpoints", {
  enumerable: true,
  get: function get() {
    return _constants.SandboxEndpoints;
  }
});
...
function provideCore(config) {
  ...
  var defaultedConfig = __assign(__assign({}, config), {
    endpoints: __assign(__assign({}, _constants.defaultEndpoints), config.endpoints)
  });
