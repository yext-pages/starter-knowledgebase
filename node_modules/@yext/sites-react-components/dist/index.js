...
var componentsTsxMaps = require('@yext/components-tsx-maps');
var componentsTsxGeo = require('@yext/components-tsx-geo');
...
var PhoneNumber__default = /*#__PURE__*/_interopDefaultLegacy(PhoneNumber);
...
const isPhone = (string) => {
  const phoneNumber = new PhoneNumber__default["default"](string);
...
function useGlobal() {
  return React.useContext(ConfigurationProviderContext);
}
...
let Link;
Link = React__default["default"].forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("a", __spreadValues$9({
    className: c__default["default"]("Link", className),
...
const Image = React__default["default"].forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("img", __spreadValues$8({
    ref,
    src: _src,
    srcSet: _srcSet,
    sizes: _sizes,
...
const Breadcrumbs = (props) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("nav", {
    className: c__default["default"]("Breadcrumbs", className),
    ...
    return /* @__PURE__ */ React__default["default"].createElement("li", {
      ...
      key: idx
    }, /* @__PURE__ */ React__default["default"].createElement(Breadcrumb, __spreadValues$7({
      label,
      link
    }, props)), !isLast && /* @__PURE__ */ React__default["default"].createElement("span", {
...
const Breadcrumb = (props) => {
  ...
  let breadcrumbEl = /* @__PURE__ */ React__default["default"].createElement("span", {
    className: "Breadcrumbs-label"
  }, label);
  if (link) {
    breadcrumbEl = /* @__PURE__ */ React__default["default"].createElement(Link$1, {
...
const YextBreadcrumbs = (props) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement(Breadcrumbs, __spreadValues$6({
    breadcrumbs
  }, props));
};
...
const Map = (props) => {
  ...
  const mapWrapper = React.useRef(null);
  ...
  React.useEffect(() => {
    if (!bounds || !mapLoaded || !map)
      return;
    const coordinates = bounds.map((bound) => new componentsTsxGeo.Coordinate(bound));
  ...
  React.useEffect(() => {
    if (!mapLoaded || map)
      return;
    const providerMap = new componentsTsxMaps.MapOptions().withControlEnabled(controlEnabled).withDefaultCenter(center).withDefaultZoom(zoom).withPadding(padding).withPanHandler(_panHandler).withPanStartHandler(panStartHandler).withProvider(provider).withProviderOptions(providerOptions).withSinglePinZoom(singlePinZoom).withWrapper(mapWrapper.current).build();
    setMap(providerMap);
  }, [mapLoaded]);
  const loadMap = () => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("div", {
    ...
    id: "map",
    ref: mapWrapper
  }, map && /* @__PURE__ */ React__default["default"].createElement(MapContext.Provider, {
    value: {
      map,
      provider
    }
...
const Marker = ({ children, coordinate, hideOffscreen, id, mapPinOptions, markerClickHandler, markerFocusHandler, markerHoverHandler, markerStatusOptions, propertiesForStatus, zIndex }) => {
  const { map, provider } = React.useContext(MapContext);
  const marker = React.useMemo(() => {
    if (children && coordinate) {
      return new componentsTsxMaps.MapPinOptions().withCoordinate(coordinate).withHideOffscreen(hideOffscreen ? hideOffscreen : false).withPropertiesForStatus(propertiesForStatus ? propertiesForStatus : () => new componentsTsxMaps.PinProperties()).withProvider(provider).build();
...
function defaultStatusTemplate(params, props) {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("div", {
    className: c__default["default"]("HoursStatus", (props == null ? void 0 : props.className) || "")
...
const HoursStatus = (props) => {
  const [hasStatusTimeout, setHasStatusTimeout] = React.useState(false);
  ...
  return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, isClient && statusTemplateFn(statusParams, props));
};
...
const HoursTable = (props) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, isClient && /* @__PURE__ */ React__default["default"].createElement("div", {
    className: c__default["default"]("HoursTable", props.className)
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      className: c__default["default"]("HoursTable-row", { "is-today": dayData.isToday }),
      key: dayData.sortIdx
    }, /* @__PURE__ */ React__default["default"].createElement("span", {
      className: "HoursTable-day"
    }, dayData.dayOfWeek), /* @__PURE__ */ React__default["default"].createElement("span", {
      className: "HoursTable-intervals"
    }, intervalStrings.map(
      (intervalString, idx) => /* @__PURE__ */ React__default["default"].createElement("span", {
...
const LocationMap = (props) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement(Map, __spreadValues({
    bounds: [coordinate],
    controlEnabled
  }, rest), /* @__PURE__ */ React__default["default"].createElement(Marker, {
    coordinate,
    id: "location-map-marker",
    markerClickHandler,
    markerHoverHandler,
    markerFocusHandler
  }, /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, pinUrl && /* @__PURE__ */ React__default["default"].createElement(Link$1, {
    href: pinUrl,
...
const Address = (props) => {
  ...
  const addressDom = lines.map((line) => /* @__PURE__ */ React__default["default"].createElement(AddressLine, {
    addressProps: props,
    line
  }));
  let addressEl = /* @__PURE__ */ React__default["default"].createElement("div", {
    className: "Address-content",
    "data-country": address.countryCode
  }, addressDom);
  if (linkToGetDirections) {
    addressEl = /* @__PURE__ */ React__default["default"].createElement(Link$1, {
...
const AddressLine = (props) => {
  ...
  (_a = props == null ? void 0 : props.line) == null ? void 0 : _a.map((field) => {
    ...
    if (field == "city") {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressCity, {
        address: (_a2 = props == null ? void 0 : props.addressProps) == null ? void 0 : _a2.address
      }));
    } else if (field == "country") {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressCountry, {
      ...
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressExtraDescription, {
        address: (_d = props == null ? void 0 : props.addressProps) == null ? void 0 : _d.address
      }));
    } else if (field == "line1") {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressLine1, {
        address: (_e = props == null ? void 0 : props.addressProps) == null ? void 0 : _e.address
      }));
    } else if (field == "line2") {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressLine2, {
        address: (_f = props == null ? void 0 : props.addressProps) == null ? void 0 : _f.address
      }));
    } else if (field == "line3") {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressLine3, {
        address: (_g = props == null ? void 0 : props.addressProps) == null ? void 0 : _g.address
      }));
    } else if (field == "postalCode") {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressPostalCode, {
        address: (_h = props == null ? void 0 : props.addressProps) == null ? void 0 : _h.address
      }));
    } else if (field == "region") {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressRegion, {
      ...
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(AddressSublocality, {
        address: (_k = props == null ? void 0 : props.addressProps) == null ? void 0 : _k.address
      }));
    } else {
      lineDom.push(/* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, field));
    }
  });
  ...
  for (var i = 0; i < lineDom.length; i++) {
    ...
    if (i != 0 && e != null && ((_b = e.props) == null ? void 0 : _b.children) != ",") {
      modifiedAddressDom.push(/* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, " "));
    }
...
const AddressLine1 = (props) => {
  var _a;
  return ((_a = props.address) == null ? void 0 : _a.line1) ? /* @__PURE__ */ React__default["default"].createElement("span", {
...
const AddressLine2 = (props) => {
  var _a;
  return ((_a = props.address) == null ? void 0 : _a.line2) ? /* @__PURE__ */ React__default["default"].createElement("span", {
...
const AddressLine3 = (props) => {
  var _a;
  return ((_a = props.address) == null ? void 0 : _a.line3) ? /* @__PURE__ */ React__default["default"].createElement("span", {
...
const AddressPostalCode = (props) => {
  var _a;
  return ((_a = props.address) == null ? void 0 : _a.postalCode) ? /* @__PURE__ */ React__default["default"].createElement("span", {
...
const AddressSublocality = (props) => {
  var _a;
  return ((_a = props.address) == null ? void 0 : _a.sublocality) ? /* @__PURE__ */ React__default["default"].createElement("span", {
...
const AddressCity = (props) => {
  var _a;
  return ((_a = props.address) == null ? void 0 : _a.city) ? /* @__PURE__ */ React__default["default"].createElement("span", {
...
const AddressRegion = (props) => {
  ...
  if (region != "") {
    if (props.abbr) {
      return /* @__PURE__ */ React__default["default"].createElement("abbr", {
...
const AddressExtraDescription = (props) => {
  var _a;
  return ((_a = props.address) == null ? void 0 : _a.extraDescription) ? /* @__PURE__ */ React__default["default"].createElement("span", {
...
exports.Breadcrumbs = YextBreadcrumbs;
exports.Button = Button;
exports.ConfigurationProvider = ConfigurationProvider;
exports.CustomBreadcrumbs = Breadcrumbs;
exports.Hours = Hours;
exports.HoursInterval = HoursInterval;
exports.HoursStatus = HoursStatus;
exports.HoursTable = HoursTable;
exports.Image = Image;
exports.Link = Link$1;
...
exports.defaultStatusTemplate = defaultStatusTemplate;
exports.getDirections = getDirections;
exports.intervalsListsAreEqual = intervalsListsAreEqual;
