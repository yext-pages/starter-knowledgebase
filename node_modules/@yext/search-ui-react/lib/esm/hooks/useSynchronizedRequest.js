 ...
 */
export function useSynchronizedRequest(executeRequest, handleRejectedPromise) {
    ...
    const [synchronizedResponse, setSynchronizedResponse] = useState();
    const executeSynchronizedRequest = useCallback(async (data) => {
