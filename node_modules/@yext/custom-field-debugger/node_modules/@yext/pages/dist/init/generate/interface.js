...
async function runGenerate() {
  return new Promise(() => {
    render(/* @__PURE__ */ React.createElement(Generator, null));
  });
}
const Generator = () => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, steps.map((step, i) => {
    ...
    return /* @__PURE__ */ React.createElement(Fragment, {
      ...
      color: "green"
    }, "\u2713"), " ", step.title), error && step.output.map((output) => output.content && /* @__PURE__ */ React.createElement(Text, {
      key: i,
    ...
    color: "greenBright"
  }, "Done!"), " Try following commands to start:", "\n", /* @__PURE__ */ React.createElement(Text, {
    bold: true
