...
export declare const generateTestDataForPage: (stdout: NodeJS.WriteStream, featuresConfig: FeaturesConfig, entityId: string, projectStructure: ProjectStructure) => Promise<any>;
