const validateTemplateModuleInternal = (templateModule) => {
  ...
  if (!templateModule.default && !templateModule.render) {
    throw new Error(`Module ${templateModule.filename} does not have the necessary exports to produce page. A module should either have a React component as a default export or a render function.`);
  }
};
const validateConfig = (filename, templateConfigInternal) => {
