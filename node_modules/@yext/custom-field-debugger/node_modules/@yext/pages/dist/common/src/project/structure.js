...
class ProjectStructure {
  ...
  constructor(config) {
    ...
    this.sitesConfigRoot = new Path(this.#config.filepathsConfig.sitesConfigRoot);
    ...
    this.hydrationBundleOutputRoot = new Path(this.#config.filepathsConfig.distRoot + "/" + this.#config.filepathsConfig.hydrationBundleOutputRoot);
    this.serverBundleOutputRoot = new Path(this.#config.filepathsConfig.distRoot + "/" + this.#config.filepathsConfig.serverBundleOutputRoot);
